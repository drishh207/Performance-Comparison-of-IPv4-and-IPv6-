...
def ping_host_v4(host, collection_info, current_date_format, provider_name):
    ...
    for _ in range(40):
        try:
            ...
            ip_match = re.search(r"\(([\da-fA-F:]+)\)", output.decode())
            if ip_match:
    ...
    json_obj = {"Date" : current_date_format, "Network Service Provider" : provider_name,"URL" : host, "IPv6 Address" : ip_address, "IPv6 City" : city, "IPv6 County" : country, "IPv6 Organisation" : org, "IPv6 RTT" : rtt, "Traceroute Data IPv6" : parsed_data}
...
def main():
    ...
    current_date_format = datetime.datetime(one_day_before_date.year, one_day_before_date.month, one_day_before_date.day)
